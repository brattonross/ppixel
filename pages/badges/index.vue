<template>
  <div class="container flex flex-col py-16">
    <div class="mb-8">
      <h2 class="text-4xl font-bold font-display leading-tight">Badges</h2>
      <p class="text-gray-600">
        Convert badges to 72x72, 36x36, and 18x18.
      </p>
    </div>
...
export default {
  ...
  methods: {
    ...
    async onChange(e) {
      await this.$store.dispatch('badges/ADD_FILES', {
    ...
    onDeleteClick() {
      for (const id of this.selected) {
        this.$store.commit('badges/REMOVE_IMAGE', { id })
      }
